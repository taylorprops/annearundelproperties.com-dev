@extends('layouts.app')
@section('title', 'Affiliated Partners | Anne Arundel Properties | Buying and Selling Real Estate in DC, MD, VA and PA')
@section('content')
<style type="text/css">
.page-container	{
	margin-top: 10rem;
	...
	<div class="row">
		...
		<div class="col-md-9 col-lg-9 ml-auto d-flex align-items-center mt-4 mt-md-0">
			<div>
				...
				<p>Make the most out of your relationship with Anne Arundel Properties by choosing Heritage Title for your title & escrow needs. </p>
