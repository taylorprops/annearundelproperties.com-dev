...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px;max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
	Anne Arundel Properties - Property Manager
</div>
@component('mail::header', ['url' => config('app.url')])
<img src="{{ asset('/images/logos/logo-horizantal-white.png') }}" width="200" alt="Anne Arundel Properties">
@endcomponent
@endslot
...
Welcome {{ $user -> name }},
<br>
Thank you for registering your Property Manager account with Anne Arundel Properties.
<br>
<br>
